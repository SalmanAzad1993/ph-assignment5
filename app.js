// All variables globally declared  
...
// Find meal in themealdb and fetch meal by API
function findMeal(e) {
  e.preventDefault();
  ...
  if (searchTerm.trim()) {
    ...
    .then(data => {
      ...
      if (data.meals === null) {
        showResult.innerHTML = `<p>You have searched wrong meal. Try again!<p>`;
      }
      else {
    ...
    alert('Warning! Please enter a valid meal...');
  }
}
